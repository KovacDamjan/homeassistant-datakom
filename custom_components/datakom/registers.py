...
SENSOR_DEFINITIONS: tuple[SensorDefinition, ...] = (
    ...
    SensorDefinition("oil_temperature", "Oil temperature", UnitOfTemperature.CELSIUS, SensorDeviceClass.TEMPERATURE, SensorStateClass.MEASUREMENT),
    SensorDefinition("canopy_temperature", "Canopy temperature", UnitOfTemperature.CELSIUS, SensorDeviceClass.TEMPERATURE, SensorStateClass.MEASUREMENT),
    SensorDefinition("ambient_temperature", "Ambient temperature", UnitOfTemperature.CELSIUS, SensorDeviceClass.TEMPERATURE, SensorStateClass.MEASUREMENT),
